...
function dbGet(db, storeName, path) {
    return new Promise((resolve, reject) => {
...
//ASSETSにロード
async function loadToASSETS(storeName, path, data) {
    if (storeName === "html") {
...
//1ファイルロード
async function loadOneFile(db, storeName, path, version, updateProgress) {
...
//シナリオファイル1ファイルロード
async function loadOneScenario(db, path, version) {
